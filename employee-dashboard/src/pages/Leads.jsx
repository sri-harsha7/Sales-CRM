...
//   const [openDateIndex, setOpenDateIndex] = React.useState(null);
...
//           {["Ongoing", "Ongoing", "Closed"].map((status, i) => (
//             <div className={styles.card} key={i}>
//               {/* Status sidebar */}
//               <div
//                 className={`${styles.sideBar} ${styles[status.toLowerCase()]}`}
//               ></div>

//               {/* Lead details */}
//               <div className={styles.details}>
//                 <h3>Tanner Finsha</h3>
//                 <p className={styles.email}>@Tannerfisher@gmail.com</p>
...
//                     <button
//                       onClick={() => {
//                         console.log("Date:", date, "Time:", time); // You can update your data here
//                         setOpenDateIndex(null); // close popup
//                       }}
//                     >
//                       Save
//                     </button>
...
//                     styles[`${status.toLowerCase()}Circle`]
//                   }`}
//                 >
//                   {status}
//                 </div>
